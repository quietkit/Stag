...
final class Preferences: ObservableObject {
    static let defaultsKey = "com.ganwar.Stag.preferences"

    @Published var defaultFormat: CaptureFormat = .png
    @Published var jpegQuality: Double = 0.9
    @Published var savePath: String = "~/Desktop/Stag Screenshots"
    @Published var filePrefix: String = "Stag_"
    ...
    private func load() {
        ...
        filePrefix = decoded.filePrefix ?? "Stag_"
