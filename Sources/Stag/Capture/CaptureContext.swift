...
///
/// `sourceAppName` must be recorded at hotkey-dispatch time — BEFORE Stag
/// activates itself — otherwise the frontmost app is already Stag.
