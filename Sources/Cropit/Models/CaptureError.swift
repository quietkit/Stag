...
enum CaptureError: LocalizedError {
    ...
    var recoverySuggestion: String? {
        switch self {
        case .screenRecordingPermissionDenied:
            return "1. Open System Settings → Privacy & Security → Screen Recording\n2. Click the + button and add Cropit from the Applications or build folder\n3. Check the checkbox next to Cropit\n4. Quit and relaunch the app"
        case .captureFailed:
        ...
        case .storageError:
            return "Check disk space and permissions in ~/Library/Application Support/Cropit/"
        default:
            return nil
        }
    }
