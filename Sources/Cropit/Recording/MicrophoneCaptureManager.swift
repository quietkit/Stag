...
final class MicrophoneCaptureManager: NSObject {
    ...
    private let processingQueue = DispatchQueue(label: "com.ganwar.Cropit.mic.processing")
    private let logger = Logger(subsystem: "com.ganwar.Cropit", category: "MicCapture")
