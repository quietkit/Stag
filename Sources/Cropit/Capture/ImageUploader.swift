...
/// Configuration for uploading a PNG to a user-controlled endpoint. Cropit never
...
enum ImageUploader {
    ...
    static func upload(_ png: Data, config: UploadConfig) async throws -> String {
        ...
        if config.fieldName.isEmpty {
            ...
            body.appendString("Content-Disposition: form-data; name=\"\(config.fieldName)\"; filename=\"cropit.png\"\r\n")
